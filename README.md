...
| Name | Source | Version |
| ---- | ------ | ------- |
| <a name="module_access_logs"></a> [access\_logs](#module\_access\_logs) | cloudposse/lb-s3-bucket/aws | 0.20.0 |
